...
a = 1131;
PT = min_Gtag_results(a,1);Gtx = min_Gtag_results(a,2); Grx = min_Gtag_results(a,3); Gt = min_Gtag_results(a,4); r = 1:20;
Ptag = PT + Gtx + Gt + path;
G_tag = Gqtr(Ptag);
P_backscattered = Ptag + G_tag + Gt + Grx + path;

plot(r,P_backscattered)
