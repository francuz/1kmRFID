...
hold on
mv60 = scatter(r, Pdbm_60mv_250k, 300, 'g');
set(mv60, ...
    'Marker', 'o', ...
    'MarkerFaceColor', 'g');
hold on
mv601m = scatter(r, Pdbm_60mv_1M, 300, 'm');
set(mv601m, ...
    'Marker', 'p', ...
    'MarkerFaceColor', 'm');
...
Legend = legend('Theoretical Link Budget', '$V_{DC}$ = 60.0 mV, $f_m$ = 250 kHz','$V_{DC}$ = 60.0 mV, $f_m$ = 1 MHz');
